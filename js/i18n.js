...
window.EdgeOpsI18n = {
  ja: {
    ...
    form_signup_organization_name: '法人・団体名（任意）',
    note_signup_organization_name: '法人・団体に所属している場合のみ入力してください。施設名・店舗名ではなく、運営する法人・団体の名称を入力してください',
    ...
    err_signup_organization_name_too_long: '法人・団体名は100文字以内で入力してください。',
  ...
  en: {
    ...
    form_signup_organization_name: 'Company / organization name (optional)',
    note_signup_organization_name: 'Enter only if you belong to a company or organization. Enter the operating company or organization name, not the facility or store name.',
    ...
    err_signup_organization_name_too_long: 'Company / organization name must be 100 characters or fewer.',

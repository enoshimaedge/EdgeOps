...
window.EdgeOpsI18n = {
  ja: {
    ...
    note_signup_facility_name:  '建物や事業所の名前を入れてください（例：藤沢オフィス）。法人名は入力不要です',
  ...
  en: {
    ...
    note_signup_facility_name:  'Enter the building or business name (e.g. Fujisawa Office). Company name is not required.',

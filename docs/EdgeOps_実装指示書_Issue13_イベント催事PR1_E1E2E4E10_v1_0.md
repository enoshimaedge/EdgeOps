...
**作成**：2026/7/25 ／ 根拠：チャッピー第154回判定（条件付きGO）
**正本**：`EdgeOps_ST版イベント催事モード仕様書_v1_4.docx` 第3-1章・第4章・第5章・第8章・第14章
...
| # | ファイル | 変更内容 |
|---|---|---|
| 1 | `index.html` | HTML追加2箇所・JS変更6箇所 |
...
| # | 確認項目 |
|---|---|
| 1 | フロント2で、ホーム・連絡一覧・詳細・プロフィールの表示が7/24と一切変わっていない |
...
2. PR差分を確認する（**変更が `index.html` と `js/i18n.js` の2ファイルのみであること**）
3. マージ・本番反映
